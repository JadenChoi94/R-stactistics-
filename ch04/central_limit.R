...
hist(b.64.mean, prob=T, xlim=c(0.5, 1.5), main='표본크기:64', 
     col='orange',border='red')
x4<-seq(min(b.64.mean), max(b.64.mean), length=1000)
y4<-dnorm(x=x3, mean=1, sd=sqrt(0.9)/sqrt(64))
